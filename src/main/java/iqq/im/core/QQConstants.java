 ...
 */
/**
 * Project : WebQQCore Package : iqq.im.core File : QQConstants.java Author :
 * solosky < solosky772@qq.com >
 * Created : 2012-9-1 License : Apache License 2.0
 */
package iqq.im.core;
...
public interface QQConstants {
    ...
    public static final String URL_SET_LONG_NICK = "http://s.web2.qq.com/api/set_long_nick2";
