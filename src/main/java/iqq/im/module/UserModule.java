 ...
 */
/**
 * Project : WebQQCoreAsync Package : iqq.im.module File : UserModule.java
...
import iqq.im.action.SetLongNick;
...
public class UserModule extends AbstractModule {
    ...
    public QQActionFuture setLongNick(String longNick, QQActionListener listener) {
        return pushHttpAction(new SetLongNick(getContext(), listener, longNick));
    }
}
