 ...
 */
/**
 * Project : WebQQCore Package : iqq.im.service File : ApacheHttpService.java
 * Author : solosky < solosky772@qq.com >
 * Created : 2013-2-27 License : Apache License 2.0
 */
...
public class ApacheHttpService extends AbstractService implements HttpService {
    ...
    public void destroy() throws QQException {
        ...
        try {
            ...
            Logger.getLogger(ApacheHttpService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
