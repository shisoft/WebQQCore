...
import net.shisoft.cloud.beans.ServiceEssentials;
...
//    QQClient client;
//
//    public Sandbox(String user, String pwd) {
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ClassQQ qq = new ClassQQ();
        qq.sayHello(new ServiceEssentials(null, null, null));
        qq.Login("376701894", "shisoft003038");
        //Sandbox test = new Sandbox("376701894", "shisoft003038");
        //test.login();
    }
